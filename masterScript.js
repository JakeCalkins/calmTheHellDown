...
function itemOneLocationStorage(){
	...
	var displayLocationOne = applianceLocation.options[applianceLocation.selectedIndex].text;
}

function itemTwoNameStorage(){
	document.getElementById("app").value = applianceName2.options[applianceName2.selectedIndex].text;
	var displayItemTwo = applianceName2.options[applianceName2.selectedIndex].text;
}
...
function itemTwoLocationStorage(){
	...
	var displayLocationTwo = applianceLocation2.options[applianceLocation2.selectedIndex].text;
}

function itemThreeNameStorage(){
	document.getElementById("app").value = applianceName3.options[applianceName3.selectedIndex].text;
	var displayItemThree = applianceName3.options[applianceName3.selectedIndex].text;
}
...
function itemThreeLocationStorage(){
	...
	var displayLocationThree = applianceLocation3.options[applianceLocation3.selectedIndex].text;
}

function itemFourNameStorage(){
	document.getElementById("app").value = applianceName4.options[applianceName4.selectedIndex].text;
	var displayItemFour = applianceName4.options[applianceName4.selectedIndex].text;
}
...
function itemFiveNameStorage(){
	...
	var displayItemFive = applianceName5.options[applianceName5.selectedIndex].text;
}
...
function itemFiveLocationStorage(){
	...
	var displayLocationFive = applianceLocation5.options[applianceLocation5.selectedIndex].text;
}

function itemSixNameStorage(){
	document.getElementById("app").value = applianceName6.options[applianceName6.selectedIndex].text;
	var displayItemSix = applianceName6.options[applianceName6.selectedIndex].text;
}
...
function itemSixLocationStorage(){
	...
	var displayLocationSix = applianceLocation6.options[applianceLocation6.selectedIndex].text;
}

function itemSevenNameStorage(){
	document.getElementById("app").value = applianceName7.options[applianceName7.selectedIndex].text;
	var displayItemSeven = applianceName7.options[applianceName7.selectedIndex].text;
}
...
function itemSevenLocationStorage(){
	...
	var displayLocationSeven = applianceLocation7.options[applianceLocation7.selectedIndex].text;
}

function itemEightNameStorage(){
	document.getElementById("app").value = applianceName8.options[applianceName8.selectedIndex].text;
	var displayItemEight = applianceName8.options[applianceName8.selectedIndex].text;
}
...
function itemEightLocationStorage(){
	...
	var displayLocationEight = applianceLocation8.options[applianceLocation8.selectedIndex].text;
}

function itemNineNameStorage(){
	document.getElementById("app").value = applianceName9.options[applianceName9.selectedIndex].text;
	var displayItemNine = applianceName9.options[applianceName9.selectedIndex].text;
}
...
function itemNineLocationStorage(){
	...
	var displayLocationNine = applianceLocation9.options[applianceLocation9.selectedIndex].text;
}

function itemTenNameStorage(){
	document.getElementById("app").value = applianceName10.options[applianceName10.selectedIndex].text;
	var displayItemTen = applianceName10.options[applianceName10.selectedIndex].text;
}
...
function itemTenLocationStorage(){
	...
	var displayLocationTen = applianceLocation10.options[applianceLocation10.selectedIndex].text;
}
...
function itemElevenNameStorage(){
	...
	var displayItemEleven = applianceName11.options[applianceName11.selectedIndex].text;
}
...
function itemElevenLocationStorage(){
	...
	var displayLocationEleven = applianceLocation11.options[applianceLocation11.selectedIndex].text;
}
...
function itemTwelveNameStorage(){
	...
	var displayItemTwelve = applianceName12.options[applianceName12.selectedIndex].text;
}
...
function itemTwelveLocationStorage(){
	...
	var displayLocationTwelve = applianceLocation12.options[applianceLocation12.selectedIndex].text;
}
...
function itemThirteenNameStorage(){
	...
	var displayItemThirteen = applianceName13.options[applianceName13.selectedIndex].text;
}
...
function itemThirteenLocationStorage(){
	...
	var displayLocationThirteen = applianceLocation13.options[applianceLocation13.selectedIndex].text;
}
...
function itemFourteenNameStorage(){
	...
	var displayItemFourteen = applianceName14.options[applianceName14.selectedIndex].text;
}
...
function itemFourteenLocationStorage(){
	...
	var displayLocationFourteen = applianceLocation14.options[applianceLocation14.selectedIndex].text;
}
...
function itemFifteenNameStorage(){
	...
	var displayItemFifteen = applianceName15.options[applianceName15.selectedIndex].text;
}
